		...
		drawingBoardRender: function (tpl, params) {
			...
			setTimeout(function () {
				...
				$box.find('button.dwz-btn-submit').click(function () {
					var strBase64 = brush.toDataURL();
					// console.log(strBase64);

					var $form = $.navView.getBox();
					var $signInput = $form.find('input.dwz-sign-input').val(strBase64.replace("data:image/jpeg;base64,", ""));
					var imgHtml = '<img src="'+strBase64+'"><a class="btn-txt">重新签名</a>';
					var $signBox = $form.find('.dwz-sign-box');
