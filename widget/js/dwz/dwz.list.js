...
$.fn.extend({
	list: function (options) {
		var op = $.extend({
			pullDown$: 'div.pullDown', pullUp$: 'div.pullUp', pullDownLabel$: 'span.pullDownLabel', pullUpLabel$: 'span.pullUpLabel', scroll$: '.scroll',
...
$.extend({
	listForm: function ($form) {
		var $list = $form.find('div.dwz-list');
		...
		var $page = $form.find('input[name="' + dwz.config.pageInfo.pageNum + '"]');
		$list.list({
			refreshFn: function () {
