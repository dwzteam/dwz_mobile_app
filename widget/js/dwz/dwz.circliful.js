            ...
            circleContainer
                ...
                .append(
                    $('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="5 20 194 186" class="circliful">' +
                        ...
                        icon +
                        '<text class="timer" text-anchor="middle" x="' + textX + '" y="' + textY + '" style="font-size: ' + settings.percentageTextSize + 'px; ' + settings.textAdditionalCss + '" fill="' + settings.fontColor + '">0%</text>')
                );
